...
export class HelperPosts extends Component {
  constructor(props) {
    super(props);
            ...
            <section className="mx-[1.5rem] mt-[1.5rem] bg-[#2a2a2a] p-3 flex gap-2 rounded-xl">
              ...
              <section className="w-[40%] text-center flex flex-col items-center">
                ...
                <div className="mt-2">
                  ...
                  <p className="mt-0 opacity-40 text-sm">
                    maphariphumudzo57@gmail.com
                  </p>
                </div>
                <div className="flex gap-2 items-center mt-2">
                  <button className="px-2 py-1 bg-yellow-600 rounded transition-all duration-700 ease-linear hover:bg-yellow-700">
                    <i className="fa-solid fa-envelope mr-1"></i>
                    <span>Message</span>
                  </button>
                  <button className="px-2 py-1 bg-cyan-600 rounded transition-all duration-700 ease-linear hover:bg-cyan-700">
