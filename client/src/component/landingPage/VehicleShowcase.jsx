    ...
    <>
      <section className="vehicleShowcase-container">
        <div className="vehicleShowcase-container__inner">
          <h1 className="text-5xl font-[900]">Vehicles in <span className="text-yellow-500">communicatee.</span></h1>
          ...
          <button className="bg-yellow-500 p-2 font-bold text-white">Find out more</button>
        </div>

        <img
          src={carsImage}
          alt="cars that communicatee offers"
        />
      </section>
    </>
  );
