    ...
    <>
      <motion.section className="features-container">
        ...
        <section className="flex items-center gap-2 flex-wrap mt-5 mb-10">
          <div className="bg-[#333] text-white rounded py-3 px-4 max-w-[20rem] transition-all duration-700 ease-linear hover:drop-shadow-2xl hover:bg-[#333] hover:cursor-pointer hover:scale-110 hover:z-[100]">
          ...
          <div className="bg-[#333] text-white py-3 rounded px-4 max-w-[20rem] transition-all duration-700 ease-linear hover:drop-shadow-2xl hover:bg-[#333] hover:cursor-pointer hover:scale-110 hover:z-[100]">
